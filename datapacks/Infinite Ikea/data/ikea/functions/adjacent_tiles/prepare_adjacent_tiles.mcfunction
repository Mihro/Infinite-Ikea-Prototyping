...
execute if entity @s[tag=!wall_north] positioned ~ ~ ~-5 if block ~ ~ ~ air run function ikea:adjacent_tiles/place_adjacent
execute if entity @s[tag=!wall_south] positioned ~ ~ ~5 if block ~ ~ ~ air run function ikea:adjacent_tiles/place_adjacent
execute if entity @s[tag=!wall_east] positioned ~5 ~ ~ if block ~ ~ ~ air run function ikea:adjacent_tiles/place_adjacent
execute if entity @s[tag=!wall_west] positioned ~-5 ~ ~ if block ~ ~ ~ air run function ikea:adjacent_tiles/place_adjacent