...
function ikea:tile_creation/type/1x2/place/position/find_placement
# Success check
...
execute if block ~1 ~ ~ light_blue_concrete at @e[tag=chosen_placement] run function ikea:tile_creation/type/1x2/place/data/set_data
# Success check
...
execute if block ~1 ~ ~ yellow_concrete at @e[tag=chosen_placement] run function ikea:tile_creation/type/1x2/place/trigger_structure_blocks

# Place adjacent tile triggers
execute if block ~1 ~ ~ yellow_concrete at @e[tag=chosen_placement] run function ikea:tile_creation/type/1x2/place/adjacent/place_adjacent_triggers
