...
function ikea:tile_creation/type/1x3/place/position/find_directions
# Mark valid placements in valid directions (16)
execute at @e[tag=placement_direction] run function ikea:tile_creation/type/1x3/place/position/find_orientations
