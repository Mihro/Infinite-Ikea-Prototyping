...
setblock ^ ^ ^14 structure_block{mode: "LOAD", posY: 3, showboundingbox: 1b}

# Set structure block name data
function ikea:tile_creation/type/1x3/place/data/name/set_name

# Set structure block rotation data
function ikea:tile_creation/type/1x3/place/data/rotation/set_rotation
